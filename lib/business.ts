 ...
 */
export function reminderMessage(inv: Invoice, daysOverdue: number, businessName: string) {
  ...
  return (
    ...
    `non-deductible penal interest. You can pay securely here: ${paymentLink(inv)}. Thank you, ${businessName}.`
  );
}
